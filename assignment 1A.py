...
# program repeat until it reach target and prevent the infinite loop
while cost > target and count < 1000:
    dm = (1/N)*(error1*x+error2*x1+error3*x2) # partial derivative of m =(1/N) * sum of (error*x)  
